...
df1 = pd.read_csv("Factory1PANC.csv")
y1 = df_process(df1)

df3 = pd.read_csv("Factory3PANC.csv")
y3 = df_process(df3)

df9 = pd.read_csv("Factory9PANC.csv")
y9 = df_process(df9)
...
plt.suptitle("Parking Area Category Utilization Rate vs Time", fontsize=16)
